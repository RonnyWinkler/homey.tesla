// Tesla documentation for vehicle commands:
...
class TeslaCommandApi {
    ...
    encodeInformationRequestKeyRequest(publicKey) {
    ...
    encodeInformationRequestCarRequest(publicKey) {
      const publicKeyBytes = Array.from(publicKey);
      const unsignedMessagePayload = {
        InformationRequest: {
          // INFORMATION_REQUEST_TYPE_GET_STATUS = 0;
          // INFORMATION_REQUEST_TYPE_GET_WHITELIST_INFO = 5;
          // INFORMATION_REQUEST_TYPE_GET_WHITELIST_ENTRY_INFO = 6;
          informationRequestType: this.vcsecInformationRequestType.INFORMATION_REQUEST_TYPE_GET_STATUS,
          publicKey: publicKeyBytes
        }
      }
