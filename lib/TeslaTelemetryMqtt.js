...
class TeslaTelemetryMqtt {
    ...
    _convertMessage(message) {
        ...
        switch (message.field) {
            ...
            // Powertrain
            case 'DiHeatsinkTF':
                json["powertrain_state"]["inverter_temp_f"] = message.value;
                break;
            case 'DiHeatsinkTR':
                json["powertrain_state"]["inverter_temp_r"] = message.value;
                break;
            case 'DiStatorTempF':
                json["powertrain_state"]["stator_temp_f"] = message.value;
                break;
            case 'DiStatorTempR':
                json["powertrain_state"]["stator_temp_r"] = message.value;
                break;
            ...
            case 'HvacPower':
                switch (message.value) {
                    ...
                    case 'HvacPowerStatePrecondition':
                        json["climate_state"]['is_climate_on'] = true;
                        json["climate_state"]['is_preconditioning'] = true;
                        break;
            ...
            case 'FdWindow':
                switch (message.value) {
                    ...
                    case 'WindowStateClosed':
                        json["vehicle_state"]['fd_window'] = 0;                       
                        break;
                    case 'WindowStatePartiallyOpen':
                    case 'WindowStateOpened':
                        json["vehicle_state"]['fd_window'] = 1;
                        break;
                }
                break;
            case 'RdWindow':
