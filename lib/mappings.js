...
function mapCarDataBle2FleetApi(carDataBle, carDataFleetApi = _getInitialCarDataFleetApi()){
  if (carDataBle.chargeState){
    ...
    carDataFleetApi.charge_state.usable_battery_level       = carDataBle.chargeState.usableBatteryLevel;
...
// function mapCarDataTelemetry2FleetApi(carDataTelemetry, carDataFleetApi = _getInitialCarDataFleetApi()){

//   if (!carDataFleetApi['charge_state']){
//     carDataFleetApi['charge_state'] = {}
//   }
//   if (carDataTelemetry?.Soc)
//       carDataFleetApi.charge_state.battery_level                = Math.round(carDataTelemetry.Soc *100)/100;
//   if (carDataTelemetry?.ChargeState)
//     carDataFleetApi.charge_state.charging_state                 = carDataTelemetry.ChargeState;
//   // Source:
//   // "Idle"
//   // ...
//   // Target:
...
//     carDataFleetApi['drive_state'] = {}
//   }
//   if (carDataTelemetry?.Gear && carDataTelemetry?.Gear.invalid != true)
//     carDataFleetApi.drive_state['shift_state']                  = carDataTelemetry.Gear;
//   if (carDataTelemetry?.Location?.locationValue?.latitude)
//     carDataFleetApi.drive_state['latitude']                     = carDataTelemetry.Location.latitude;
//   if (carDataTelemetry?.Location?.locationValue?.longitude)
//     carDataFleetApi.drive_state['longitude']                    = carDataTelemetry.Location.longitude;
  
//   if (!carDataFleetApi['climate_state']){
//     carDataFleetApi['climate_state'] = {}
//   }
//   if (carDataTelemetry?.InsideTemp)
//     carDataFleetApi.climate_state['inside_temp']                = Math.round(carDataTelemetry.InsideTemp *100)/100;
//   if (carDataTelemetry?.OutsideTemp)
//     carDataFleetApi.climate_state['outside_temp']               = Math.round(carDataTelemetry.OutsideTemp *100)/100;
